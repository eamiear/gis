...
*/
define(["esri/graphic", "esri/geometry/webMercatorUtils", "esri/geometry/Circle", "esri/symbols/SimpleFillSymbol", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleMarkerSymbol", "esri/symbols/PictureMarkerSymbol", "esri/symbols/PictureFillSymbol", "esri/symbols/Font", "esri/symbols/TextSymbol", "esri/toolbars/draw"],
function(
graphic, webMercatorUtils, Circle, SimpleFillSymbol, SimpleLineSymbol, SimpleMarkerSymbol, PictureMarkerSymbol, PictureFillSymbol, Font, TextSymbol, draw) {
  return declare(null,
  /**  @lends module:extras/control/LayerDraw */
  {
    ...
    addCircle: function(params, fillSymbol, attributs) {
      var pt = new esri.geometry.Circle(params);
      var textsym = new esri.symbols.SimpleFillSymbol(fillSymbol || this.defaultSymbol.Polygon);
      var graphic = new esri.Graphic(pt, textsym, attributs);
      this.toolbar.drawLayer.add(graphic);
      return graphic;
    ...
    addExtent: function(params, id, fillSymbol) {
      var pt = new esri.geometry.Extent(params);
      var textsym = new esri.symbols.SimpleFillSymbol(fillSymbol || this.defaultSymbol.Polygon);
      var graphic = new esri.Graphic(pt, textsym, null);
      id && (graphic.id = id);
      this.toolbar.drawLayer.add(graphic);
    },
