...
*/
define(["dojo/_base/event", "esri/toolbars/draw", "esri/symbols/SimpleMarkerSymbol", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleFillSymbol", "esri/symbols/PictureMarkerSymbol", "esri/symbols/Font", "esri/symbols/TextSymbol", "esri/layers/GraphicsLayer", "esri/graphic", "esri/Color", "esri/units", "esri/geometry/geodesicUtils", "esri/geometry/webMercatorUtils"],
function(
event, draw, SimpleMarkerSymbol, SimpleLineSymbol, SimpleFillSymbol, PictureMarkerSymbol, Font, TextSymbol, GraphicsLayer, graphic, Color, units, geodesicUtils, webMercatorUtils) {
  return declare([esri.toolbars.draw],
