    ...
    return declare(null, /**  @lends module:extras/MapInitObject */
      {
        ...
        setMapOptions: function (mapParam) {
          ...
          this.currentOptions = {
            logo: false,
            slider: true,
            center: mapParam.center || new Point(12615151.657772028, 2645790.939302407, this.spatialReference),
            level: 10
        ...
        createTiledLayer: function (layerObj) {
          ...
          var layer = new ArcGISTiledMapServiceLayer(layerObj);
          return layer;
        },
        ...
        createGraphicLayer: function (layerObj) {
          ...
          var layer = new GraphicsLayer(layerObj);
          return layer;
        },
        ...
        createDynamicLayer: function (layerObj) {
          ...
          var layer = new ArcGISDynamicMapServiceLayer(layerObj);
          return layer;
        },
        ...
        createFeatureLayer: function (layerObj) {
          ...
          var layer = new FeatureLayer(layerObj);
          return layer;
        },
        ...
        createImageLayer: function (layerObj) {
          ...
          var layer = new ArcGISImageServiceLayer(layerObj);
          return layer;
        },
        ...
        createWMSLayer: function (layerObj) {
          ...
          var layer = new WMSLayer(layerObj);
          return layer;
        },
        ...
        createWFSLayer: function (layerObj) {
          ...
          var layer = new WFSLayer(layerObj);
          return layer;
        },
        ...
        createGoogleMapLayer: function (layerObj) {
          ...
          var layer = new GoogleTiledMap(layerObj);
          return layer;
        },
        ...
        createBaiDuMapLayer: function (layerObj) {
          var layer = new BaiduTiledMap(layerObj);
          return layer;
        },
        ...
        createTianDiTuLayer: function (layerObj) {
          ...
          var layer = new TianDiTuTiledMap(layerObj);
          return layer;
        },
        ...
        drawDefaultTrack: function () {
          ...
          var bg = new Graphic(basicPolyline, basicSymbol, {},
            null);
